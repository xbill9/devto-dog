---
name: dev-run
description: Launch the Dog or Not scanner locally — picks between the mock server, the real Live API backend, and the ADK dev UI, and handles the frontend build step. Use when asked to run, start, serve, or manually try out this app.
---
